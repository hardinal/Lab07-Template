 ...
 * changed some names and comments to be more clear
 * removed manually throwing NullPointerExceptions since it is unecessary
 * and generally considered a bad coding practice.
 * @version 2015/10/21
 */
public class DoubleNode
{
    ...
    {
        this.link = new DoubleNode(data, this.link);
    }
     ...
     * head of the copy.
     * 
     * @param source the head of a linked list that will be copied.
     *      That may be an empty list in where source is null.
     * 
     ...
     * 
     * @postcondition The method has made a copy of the linked list
     *      starting at source.
     */
     ...
     *      That may be an empty list with a null head.
     * 
     ...
     * copy.
     * 
     * @param start a reference to a DoubleNode that represents the
     *      starting point for the copy.
     * @param end a reference to a DoubleNode that represents the
     *      ending point for the copy.
     * 
     ...
     * 
     * @param head the head reference for a linked list.
     *      That may be an empty list in which case the head is null.
